...
docker run -it --rm -e SEARCH_ITEMS="<ITEM>" -e STORE_NUMBER="<4-DIGIT STORE NUMBER>" -e DISCORD_WEBHOOK_URL="https://discord.com/api/webhooks/123456789/blahblahblah" publix-scraper:latest
